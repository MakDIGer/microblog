...
<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
    ...
    <form action="{{ route('admin-search') }}" method="GET" class="form-control form-control-dark w-100 m-0 p-0">
        <input class="form-control form-control-dark w-100" type="text" name="search" placeholder="Поиск"
        ...
        <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
            <div class="position-sticky pt-3">
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="{{ route('admin-main') }}">
